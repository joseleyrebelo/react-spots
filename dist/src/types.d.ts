...
export type InstantiationMethods<Values extends Partial<InstantiationValues> = InstantiationValues> = {
    readonly [key: string]: (context: ContextValuesGhost<Values>, ...args: any[]) => any;
};
export type ContextData<Context extends Partial<InstantiationValues> = InstantiationValues, Methods extends InstantiationMethods<Context> = InstantiationMethods<Context>> = {
